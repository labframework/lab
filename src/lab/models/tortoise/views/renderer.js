...
define(function (require) {
  ...
  return function TortoiseView(SVGContainer, model) {
    ...
    var api = {},
        ...
        // <label>speed<input id="speed-slider" type="range" min="0" max="8" step=".01" style="width: 400px"></label>
        // ticks: <span id="tick-counter">47</span>
        // <br>
        // <input type="button" onclick="setup();" value="setup">
        // <input id="go-button" type="button" onclick="toggleGo();" value="go">
        // 
        // <div class="view-container" style="width: 600px;"><canvas id="netlogo-canvas" width="1764" height="1116" style="width: 100%;"></canvas></div>

    SVGContainer.$el.empty();
    SVGContainer.$el.addClass('view-container');

    // NetLogo Tortoise JavaScript Engine
    ...
    // NetLogo code compiled into JavaScript
    ...
    var session     = new SessionLite(SVGContainer.$el[0]);
    ...
    window.collectUpdates = collectUpdates;
    window.SETUP = SETUP;
    window.getClimateTemp = function(){
      return Globals.getGlobal(2);
    };
    window.ADD_CLOUD = ADD_CLOUD;
    window.REMOVE_CLOUD = REMOVE_CLOUD;
    window.ADD_CO2 = ADD_CO2;
    window.REMOVE_CO2 = REMOVE_CO2;

    function goForever() {

      var speed      = Math.exp(3);
    ...
    // Renderer: repaint
    //
    // Call when container being rendered into changes size.
    //
